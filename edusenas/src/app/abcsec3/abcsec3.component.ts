...
export class Abcsec3Component {
  ...
  pages = [
    ...
    { id: 7, videoSrc: 'assets/videoimg_abecedario/abecedario/letrarr.mp4', imageSrc: 'assets/img/abc/gorra.jpeg', title: 'RR', instruction: 'Posiciona tu mano de manera vertical y dobla los dedos anular, meñique y pulgar. Coloca los dedos índice y medio rectamente, y cruza el dedo índice sobre el dedo medio. Asegúrate de que los dedos doblados se junten.' },
