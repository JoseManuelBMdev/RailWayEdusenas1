...
export class preguntasComponent {
  ...
  pages = [
    { id: 1, videoSrc: 'assets/videoimg_abecedario/cuestionamientos/caundo.mp4', imageSrc: 'assets/img/preguntas/Cuando.png', title: 'Cuando', instruction: 'Forma una A con la mano dominante  Para ello, cierra todos los dedos sobre la palma de la mano.Mueve la mano de un lado a otro en un movimiento pequeño.' },
    ...
    { id: 3, videoSrc: 'assets/videoimg_abecedario/colores/blanco.mp4', imageSrc: 'assets/img/colores/blanca.png', title: 'Blanco', instruction: 'Forma una B con la mano dominante.Coloca la mano frente al pecho, con la palma hacia adentro y los dedos apuntando hacia arriba.Desliza la mano hacia arriba desde el pecho hasta el cuello o la parte superior del pecho.' },
    ...
    { id: 7, videoSrc: 'assets/videoimg_abecedario/colores/negro.mp4', imageSrc: 'assets/img/colores/mancha.png', title: 'Negro', instruction: 'Forma una N con la mano dominante.Coloca la mano frente a ati con la palma hacia arriba , desliza la letra N sobre la palma de la mano' },
    ...
    { id: 9, videoSrc: 'assets/videoimg_abecedario/colores/rosa.mp4', imageSrc: 'assets/img/colores/rosado.png', title: 'Rosa', instruction: 'Forma una R con la mano dominante.Coloca la mano frente a ti, con la palma hacia arriba.Desliza el dedo índice y medio en forma de R por la palma de la otra mano.' },
