...
@Component({
  selector: 'app-ejerciciosabcsec1',
  standalone: true,
  imports: [CommonModule, RouterModule, FormsModule],
  templateUrl: './ejercicios-abcsec1.component.html',
  styleUrls: ['./ejercicios-abcsec1.component.css']
})
export class EjerciciosAbcsec1Component implements OnInit {
  @ViewChild('videoPlayer') videoPlayer: ElementRef<HTMLVideoElement> | undefined;
  pages = [
    {
      id: 1, 
      imageSrc: 'assets/videoimg_abecedario/abecedario/letrad.jpg', 
    ...
    {
      id: 2, 
      imageSrc: 'assets/videoimg_abecedario/abecedario/letrac.jpg', 
      question: '¿Qué letra es?',
      options: [
    ...
    {
      id: 3, 
      imageSrc: 'assets/videoimg_abecedario/abecedario/letraa.jpg', 
      question: '¿Qué letra es?',
      options: [
        { text: 'B', isCorrect: false },
        { text: 'F', isCorrect: false },
    ...
    {
      id: 4,
      imageSrc: 'assets/videoimg_abecedario/abecedario/letrab.jpg',
    ...
    {
      id: 5, 
      imageSrc: 'assets/videoimg_abecedario/abecedario/letrae.jpg', 
      question: '¿Qué letra es?',
      options: [
    ...
    {
      id: 6, 
      imageSrc: 'assets/videoimg_abecedario/abecedario/letraf.jpg', 
      question: '¿Qué letra es?',
      options: [
        { text: 'A', isCorrect: false },
        { text: 'B', isCorrect: false },
  ...
  nextLesson() {
    console.log('Navigating to /abcseccion2');
    this.router.navigate(['/abcseccion2']);
  }
